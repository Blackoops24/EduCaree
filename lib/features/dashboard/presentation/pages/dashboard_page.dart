...
class _DashboardPageState extends ConsumerState<DashboardPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final totalTeachers = staffState.staff
        .where((s) => s.designation.toLowerCase().contains('teach'))
        .length;
          ...
          Wrap(
            ...
            children: [
              ...
              _DashboardCard(
                ...
                subtitle:
                    'Student/staff attendance, biometric, face recognition',
              ...
              Expanded(
                child: Align(
                  ...
                  child: FractionallySizedBox(
                    heightFactor: amounts[index] / maxAmount,
                    child: Container(
                      width: 22,
                      decoration: BoxDecoration(
  ...
  Widget _growthChart() {
    ...
    final maxProgress = progress.reduce((a, b) => a > b ? a : b);
    return Column(
      children: [
        Expanded(
          child: Row(
                  ...
                  children: [
                    Expanded(
                      child: Align(
                        alignment: Alignment.bottomCenter,
                        child: FractionallySizedBox(
                          heightFactor: progress[index] / maxProgress,
                          child: Container(
                            width: 12,
                            decoration: BoxDecoration(
                              color: Colors.purple,
        ...
        const SizedBox(height: 4),
        const Text(
          'Strong student growth trend over the last six terms.',
          maxLines: 1,
